...
Additionally, in neutral-atom architectures, the qubits can be moved physically to be 
closer to other qubits, essentially removing the need for swap gates in the qram, with 
the only gate that the router needs being CSWAP \& inverse CSWAP gates to do the actual routing.
